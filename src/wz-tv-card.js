...
const I18N = {
  de: {
    title: "Fernseher", remote: "Fernbedienung", hdmi: "HDMI-Quelle",
    light_sync: "Licht & Sync", tv_light: "TV-Licht", sync_box: "Sync Box",
    sync: "Sync", sync_now: "Jetzt synchronisieren", sound: "Ton",
    on: "Ein", off: "Aus", settings: "Steuerung", expand: "Ein-/Ausklappen",
    power: "TV ein/aus", close: "Schließen",
    ...
    e_media: "TV Media-Player", e_tv_light: "TV-Licht Szene",
    e_sync_power: "Sync Box Power (switch)", e_sync_button: "Sync Box Sync (button)",
    e_hdmi_select: "HDMI-Quelle (select)",
    e_remotes: "Fernbedienungen (1–4)", e_hdmi_list: "HDMI-Quellen (1–4)", e_ton: "Ton-Schalter (1–4)",
    e_label: "Beschriftung", e_icon: "Icon", e_path: "Navigationspfad",
    e_option: "Select-Option", e_entity: "Entität", e_add: "Hinzufügen",
  },
  en: {
    title: "TV", remote: "Remotes", hdmi: "HDMI source",
    light_sync: "Light & Sync", tv_light: "TV light", sync_box: "Sync Box",
    sync: "Sync", sync_now: "Sync now", sound: "Sound",
    on: "On", off: "Off", settings: "Controls", expand: "Expand / collapse",
    power: "TV on/off", close: "Close",
    ...
    e_media: "TV media player", e_tv_light: "TV light scene",
    e_sync_power: "Sync Box power (switch)", e_sync_button: "Sync Box sync (button)",
    e_hdmi_select: "HDMI source (select)",
    e_remotes: "Remote buttons (1–4)", e_hdmi_list: "HDMI sources (1–4)", e_ton: "Sound toggles (1–4)",
    e_label: "Label", e_icon: "Icon", e_path: "Navigation path",
    e_option: "Select option", e_entity: "Entity", e_add: "Add",
  },
};
