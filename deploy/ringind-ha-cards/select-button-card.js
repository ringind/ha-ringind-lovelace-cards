...
const DE = { "select-button-card": {
  not_found: (e) => "Entität " + e + " nicht gefunden – bitte im Karten-Editor auswählen.",
  opt_missing: (o) => "Option „" + o + "“ ist bei dieser Entität nicht verfügbar.",
  e_entity: "Select-Entität",
  e_option: "Zu aktivierende Option",
  e_name: "Name (optional)",
  e_icon: "Icon (optional)",
  e_color: "Aktiv-Farbe",
  e_language: "Sprache",
...
const EN = { "select-button-card": {
  not_found: (e) => "Entity " + e + " not found – pick it in the card editor.",
  opt_missing: (o) => "Option “" + o + "” is not available on this entity.",
  e_entity: "Select entity",
  e_option: "Option to activate",
  e_name: "Name (optional)",
  e_icon: "Icon (optional)",
  e_color: "Active colour",
  e_language: "Language",
  e_auto: "Automatic (HA)",
  e_de: "German",
  e_en: "English"
